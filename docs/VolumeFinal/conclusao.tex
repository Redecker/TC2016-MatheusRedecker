...
\frm{Evite adjetivar tanto ``grande valor'' ``grande aprendizado''. Te atenha a afirmações objetivas e fatuais. O que tu aprendeste que tu não teria aprendido? Como isto pode ser útil?}
...
\frm{interessante também não é algo objetivo, descreva o que tu aprendeste.}
...
Pois existem técnicas que são vencidas em todos as execuções.\frm{Frase solta}
...
\frm{Frases e parágrafo solto. Leia algumas conclusões de artigos e reescreva isto.}
