...
A avaliação dos resultados está dívida por mapa.
...
Isso acontece porque, a técnica treina \textit{workers}, que é a unidade que custa menos recurso no jogo, e logo as envia para atacar, por essa razão o algoritmo não tem tempo de ter algum tipo de reação.
...
O grande problema dos domínios modelados é não ter um plano de contingência.
