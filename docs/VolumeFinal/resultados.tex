...
A partir da análise dos resultados\frm{A tabela não é a análise dos resultados, a análise dos resultados é este texto...} é possível observar que há um ganho do lado vermelho em relação ao azul nos dois domínios. 
...
Isso acontece pelo fato de que, no lado vermelho, as técnicas do MicroRTS atacam rapidamente, o que não acontece quando as técnicas estão do lado azul.\frm{Por que?}
...
Os resultados mostrar\frm{Mim tarzan}, outra vez, a vantagem do lado vermelho no jogo.
...
Fazendo com que o tamanho do código cresça.% Corretor ortográfico é seu amigo
...
Ao passar das jogadas, o tempo para gerar as jogadas diminui, isso ocorre porque nesse momento o cenário de jogo é diferente.\frm{Isto não me diz nada!! E também não é verdade. Quanto mais avançado no jogo, menos ``futuro'' tem pela frente, e isto implica em menos níveis na árvore de busca que tu tens para olhar. Também existem mais restrições no que tu pode fazer (menos recursos) e possivelmente menos ações dispiníveis.}
...
\frm[inline]{Não faço a mínima idéia do que tu queres me dizer aqui... Organize os teus pensamentos. O que tu queres dizer?}
