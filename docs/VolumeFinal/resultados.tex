...
\todo[inline]{está completo até aqui!!!!!}
...
A Figura~\ref{fig:tempo} ilustra o gráfico com os tempos obtidos para os dois domínios.
...
O tempo de geração de uma ação no algoritmo de AHTN explicar o gráfico,
picos altos são o começo do jogo, onde precisa fazer quartel e criar o ranged, como no dominio 1 só faz um o custo é menor, como o dominio 2 faz mais de um o custo é maior.....
