...
Se em algum ponto, nenhum método consiga ser aplicado, o planejador tem que realizar um retrocesso(\textit{backtracking}), que consiste em voltar a um $d$ anterior a ponto de conseguir tentar outra decomposição \cite{intelligence2003modern}. 
...
\msr[inline]{FINALIZAR PLANEJAMENTO E INTRODUZIR ML}
