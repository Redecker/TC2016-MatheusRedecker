...
Para isso existem algumas técnicas para tratar aprendizado de maquina com objetivos diferentes \cite{intelligence2003modern}, algumas delas são:\frm{Olha as concordâncias!!}
