...
%Para validar é utilizado o jogo MicroRTS como plataforma. 
\end{resumo}
...
%The game used as platform is MicroRTS.
\end{abstract}
...
%\msr{ele está com um problema na biblioteca dos algoritmos, estou tentando resolver esse problema}
...
\sigla{IA}{Inteligência Artiﬁcial}
