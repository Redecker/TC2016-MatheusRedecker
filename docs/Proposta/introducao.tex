...
A inteligencia artificial possui algumas áreas de aplicação:\frm{Isto é uma lista exaustiva?} 
\begin{itemize}
	\item Aprendizado
	\item Planejamento
	\item Jogos
...
\frm[inline]{Tu estás tentando explicar em profundidade os tipos de jogos, mas talvez seja melhor tu simplesmente colocar o problema mais genérico de programar IAs para jogos, depois te preocupa em detalhar os tipos de jogos e tipos de técnicas (isto é a parte final  da introdução)}
Jogos eletrônicos são muito populares, não só entre os jovens\frm{Se tu tens que falar ``nos jovens'', tu parece um velho, hehe}, principalmente pela grande quantidade de gêneros, existem jogos de ação, aventura, esportes, estrategia, entre outros. \frm{Evitar parágrafos de sentenças solitárias como este}


Dentro dos jogos de estratégia há uma subseção\frm{subseção?!?!} que se chama jogos de estratégia em tempo real, neles os jogadores estão se enfrentando no mesmo momento, como o nome já diz. 
