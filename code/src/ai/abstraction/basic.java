...
class Precondition0 extends Precondition
{
	...
	public Precondition0(Term[] unifier)
	{
		...
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier), 2);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition1 extends Precondition
{
	...
	public Precondition1(Term[] unifier)
	{
		...
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 2);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
