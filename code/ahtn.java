...
class Precondition1 extends Precondition
{
	...
	public Precondition1(Term[] unifier)
	{
		...
		p[2] = new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Operator1 extends Operator
{
	public Operator1()
	{
		...
		DelAddElement[] delIn = new DelAddElement[1];
		delIn[0] = new DelAddAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)));

		setDel(delIn);

		DelAddElement[] addIn = new DelAddElement[1];
		addIn[0] = new DelAddAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(0), TermList.NIL)));
...
class Operator3 extends Operator
{
	public Operator3()
	{
		...
		DelAddElement[] addIn = new DelAddElement[1];
		addIn[0] = new DelAddAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(1), TermList.NIL)));
...
class Operator4 extends Operator
{
	public Operator4()
	{
		...
		DelAddElement[] addIn = new DelAddElement[1];
		addIn[0] = new DelAddAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)));
...
class Method0 extends Method
{
	public Method0()
	{
		super(new Predicate(0, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL)))));
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(1, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL)))), false, true));
	...
	public Precondition getIterator(Term[] unifier, int which)
	{
		...
		{
			case 0:
				p = (new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier), 3)).setComparator(null);
			break;
			default:
				return null;
		}
...
class Method1 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(1, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(0, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), false, true));
	...
	public Precondition getIterator(Term[] unifier, int which)
	{
		...
		{
			case 0:
				p = (new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier), 3)).setComparator(null);
			break;
			default:
				return null;
		}
...
class Precondition4 extends Precondition
{
	...
	{
		p = new Precondition[3];
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier), 3);
		p[2] = new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition5 extends Precondition
{
	...
	public Precondition5(Term[] unifier)
	{
		p = new Precondition[3];
		p[1] = new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier), 3);
		p[2] = new PreconditionNegation(new PreconditionAtomic(new Predicate(0, 3, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier), 3);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method2 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(1, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(2, 3, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), false, true));
	...
	TaskList createTaskList1()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(4, 3, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(0), TermList.NIL))), false, true));
...
class Precondition6 extends Precondition
{
	...
	{
		p = new Precondition[3];
		p[1] = new PreconditionAtomic(new Predicate(0, 4, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		p[2] = new PreconditionAtomic(new Predicate(0, 4, new TermList(TermVariable.getVariable(2), TermList.NIL)), unifier);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method3 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(1, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(3, 4, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL)))), false, true));
	...
	TaskList createTaskList1()
	{
		...
		retVal = new TaskList(2, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(4, 4, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(3), TermList.NIL))), false, true));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL)))), false, false));
...
class Method4 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal = new TaskList(1, true);
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(5, 1, new TermList(TermVariable.getVariable(0), TermList.NIL)), false, true));
...
public class ahtn extends Domain
{
	public ahtn()
	{
		...
		compoundTasks[0] = "treinar-worker";
		compoundTasks[1] = "construir-base";
		compoundTasks[2] = "construir-quartel";
		compoundTasks[3] = "treinar-unidade";
		compoundTasks[4] = "atacar";

		primitiveTasks = new String[6];
		primitiveTasks[0] = "!base";
		primitiveTasks[1] = "!worker";
		primitiveTasks[2] = "!quartel";
		primitiveTasks[3] = "!treinar";
		primitiveTasks[4] = "!obter-recurso";
		primitiveTasks[5] = "!ataque";
